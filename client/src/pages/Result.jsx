      ...
      <div className=' bg-white rounded-lg drop-shadow-sm px-10 py-4'>
          ...
          <div className='flex flex-col sm:grid grid-cols-2 gap-10'>
              ...
              <div >
                ...
                <img className='rounded-md drop-shadow-sm ' src={image ? URL.createObjectURL(image): ''} alt="" />
              </div>
          ...
          {/* -------------------------Button---------------------- */}
          {  resultImage &&  <div className='flex justify-center sm:justify-end flex-wrap gap-4 mt-6 '>
            ...
            <a href={resultImage} download className='px-8 py-2.5 text-white text-sm bg-gradient-to-r from-violet-600 to-fuchsia-400 rounded-full hover:scale-105 transition-all duration-700' >Download image</a>
          </div>}
